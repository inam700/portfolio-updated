    ...
    <>
      ...
      <div className="mt-10">
        ...
        <p className="mt-5 text-justify md:text-left">
          ...
          full-stack development using React.js, Next.js, Node.js, Express.js
          and MongoDB. Proven success in building scalable SaaS platforms,
          responsive UIs, and secure backend architectures. Experienced in
          leading teams, delivering performance-optimized apps, and integrating
          real-time features.
        </p>
